...
#define STRING_CONFIG_H_AUTHOR "(Ads,Scorpion)" // Who made the changes.
 ...
 */
// #define PIDTEMP   //Ads        // See the PID Tuning Guide at https://reprap.org/wiki/PID_Tuning
#define MPCTEMP     //Ads    // See https://marlinfw.org/docs/features/model_predictive_control.html
 ...
 */
  ...
  #define MPC_EDIT_MENU  //Ads                           // Add MPC editing to the "Advanced Settings" menu. (~1.3K bytes of flash)
  #define MPC_AUTOTUNE_MENU   //Ads                      // Add MPC auto-tuning to the "Advanced Settings" menu. (~350 bytes of flash)
...
#define MAX_CHAMBER_POWER 255 // limits duty cycle to chamber heater; 255=full current
  ...
  #define PID_EDIT_MENU    //AdsPID     // Add PID editing to the "Advanced Settings" menu. (~700 bytes of flash)
  #define PID_AUTOTUNE_MENU  //AdsPID   // Add PID auto-tuning to the "Advanced Settings" menu. (~250 bytes of flash)
#endif
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 408.5 } //AdsSteps{ 80, 80, 400, 500 }
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 300, 300, 25, 35 } //AdsFeed{ 300, 300, 5, 25 }
 ...
 */
#define S_CURVE_ACCELERATION //AdsS-Curve
...
#define USE_PROBE_FOR_Z_HOMING //Ads
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -45, -4.5, 0 } //AdsCRTouch{ 10, 10, 0 }
...
#define PROBING_MARGIN 25 //AdsHoming (10)
 ...
 */
#define MULTIPLE_PROBING 2 //AdsCRTouch
...
#define Z_PROBE_LOW_POINT          -10 //AdsCRTouch {-2} / (mm) Farthest distance below the trigger-point to go before stopping
...
#define Z_MIN_PROBE_REPEATABILITY_TEST//AdsCRTouch
...
#define INVERT_X_DIR true//AdsINVERT (false)
...
#define Z_CLEARANCE_FOR_HOMING  10   //AdsHoming (4) (mm) Minimal Z height before homing (G28) for Z clearance above the bed, clamps, ...
                                      // You'll need this much clearance above Z_MAX_POS to avoid grinding.

#define Z_AFTER_HOMING         5   //AdsHoming (mm) Height to move to after homing (if Z was homed)
#define XY_AFTER_HOMING { 10, 10 }  //AdsHoming (mm) Move to an XY position after homing (and raising Z)
...
#define X_BED_SIZE 210 //AdsBedSize (200)
#define Y_BED_SIZE 210 //AdsBedsize (200)

// Travel limits (linear=mm, rotational=°) after homing, corresponding to endstop positions.
#define X_MIN_POS +4 //AdsBedsize (0)
#define Y_MIN_POS -7 //AdsBedsiz (0)
#define Z_MIN_POS 0
#define X_MAX_POS X_BED_SIZE+35 //AdsBedsize (X_BED_SIZE)
#define Y_MAX_POS Y_BED_SIZE
#define Z_MAX_POS 220 //AdsBedsize (200)
//#define I_MIN_POS 0
//#define I_MAX_POS 50
//#define J_MIN_POS 0
//#define J_MAX_POS 50
...
#define AUTO_BED_LEVELING_BILINEAR //AdsBedLVL
 ...
 */
#define RESTORE_LEVELING_AFTER_G28 //AdsBedLVL
//#define ENABLE_LEVELING_AFTER_G28

/**
 * Auto-leveling needs preheating
 */
#define PREHEAT_BEFORE_LEVELING //AdsBedLVL
#if ENABLED(PREHEAT_BEFORE_LEVELING)
  //#define LEVELING_NOZZLE_TEMP 120 //AdsBedLVL   // (°C) Only applies to E0 at this time
  #define LEVELING_BED_TEMP     65//AdsBedLVL (50)
#endif
...
//#define DEBUG_LEVELING_FEATURE
  ...
  //#define PROBE_Y_FIRST
    ...
    #define EXTRAPOLATE_BEYOND_GRID //AdsBedLVL

    //
    // Subdivision of the grid by Catmull-Rom method.
    // Synthesizes intermediate points to produce a more detailed mesh.
    //
    #define ABL_BILINEAR_SUBDIVISION //AdsBedLVL
 ...
 */
#define LCD_BED_LEVELING //AdsBedLVL

#if ENABLED(LCD_BED_LEVELING)
  #define MESH_EDIT_Z_STEP  0.025 // (mm) Step size while manually probing Z axis.
  #define LCD_PROBE_Z_RANGE 4     // (mm) Z Range centered on Z_MIN_POS for LCD Z adjustment
  #define MESH_EDIT_MENU//AdsBedLVL        // Add a menu to edit mesh points
#endif
 ...
 */
#define Z_SAFE_HOMING //AdsHoming
...
#define HOMING_FEEDRATE_MM_M { (15*60), (15*60), (4*60) } //AdsHoming {(50*60), (50*60), (4*60)}
 ...
 */
#define EEPROM_SETTINGS//AdsEE     // Persistent storage with M500 and M501
//#define DISABLE_M503        // Saves ~2700 bytes of flash. Disable for release!
#define EEPROM_CHITCHAT       // Give feedback on EEPROM commands. Disable to save flash.
#define EEPROM_BOOT_SILENT    // Keep M503 quiet and only give errors during first load
#if ENABLED(EEPROM_SETTINGS)
  //#define EEPROM_AUTO_INIT  // Init EEPROM automatically on any errors.
  #define EEPROM_INIT_NOW//AdsEE   // Init EEPROM on first boot after a new build.
#endif
...
#define PREHEAT_2_LABEL       "PLA+" //AdsMat
 ...
 */
// #define PRINTJOB_TIMER_AUTOSTART //AdsFeatures
...
//
#define ENCODER_PULSES_PER_STEP 5//AdsFeatures

//
// Use this option to override the number of step signals required to
// move between next/prev menu items.
//
#define ENCODER_STEPS_PER_MENU_ITEM 1//AdsFeatures
...
#define INDIVIDUAL_AXIS_HOMING_SUBMENU//AdsHoming
...
//
#define REPRAP_DISCOUNT_FULL_GRAPHIC_SMART_CONTROLLER //AdsTFT
