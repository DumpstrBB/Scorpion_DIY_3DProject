...
#define AUTOTEMP
  ...
  #define AUTOTEMP_MIN          200 //AdsAutoTemp
 ...
 */
#define HOTEND_IDLE_TIMEOUT //AdsFeatures
#if ENABLED(HOTEND_IDLE_TIMEOUT)
  #define HOTEND_IDLE_TIMEOUT_SEC (5*60)    // (seconds) Time without extruder movement to trigger protection
  #define HOTEND_IDLE_MIN_TRIGGER   180     // (°C) Minimum temperature to enable hotend protection
  #define HOTEND_IDLE_NOZZLE_TARGET  20 //AdsFeatures(0)     // (°C) Safe temperature for the nozzle after timeout
 ...
 */
#define FAN_KICKSTART_TIME  100 //AdsFAN  // (ms)
#define FAN_KICKSTART_POWER 255 //AdsFAN(180)  // 64-255
 ...
 */
#define FAST_PWM_FAN   //AdsFan // Increase the fan PWM frequency. Removes the PWM noise but increases heating in the FET/Arduino
 ...
 */
#define E0_AUTO_FAN_PIN PD12 //AdsFAN
...
#define COOLER_AUTO_FAN_PIN PA8 //AdsFAN

#define EXTRUDER_AUTO_FAN_TEMPERATURE 35 //AdsFan (50)
...
#define SENSORLESS_BACKOFF_MM  { 5, 5, 0 }  //AdsHoming ( 2, 2, 0 ) (linear=mm, rotational=°) Backoff from endstops before sensorless homing

#define HOMING_BUMP_MM      { 0, 0, 0 } //AdsHoming ( 5, 5, 2) (linear=mm, rotational=°) Backoff from endstops after first bump
#define HOMING_BUMP_DIVISOR { 2, 2, 4 } //AdsHoming      // Re-Bump Speed Divisor (Divides the Homing Feedrate)
 ...
 */
#define Z_STEPPER_AUTO_ALIGN //AdsFeatures
...
#define FT_MOTION //AdsFeatures
  ...
  #define FT_MOTION_MENU //AdsFeatures            // Provide a MarlinUI menu to set M493 parameters
 ...
 */
#define INPUT_SHAPING_X //AdsInput
#define INPUT_SHAPING_Y //AdsInput
//#define INPUT_SHAPING_Z
  ...
  #define SHAPING_MENU //AdsInput    // Add a menu to the LCD to set shaping parameters.
#endif
 ...
 */
#define DEFAULT_STEPPER_TIMEOUT_SEC 360 //AdsFeatures (120)
 ...
 */
#define ADAPTIVE_STEP_SMOOTHING //AdsFeatures
...
//#define BEEP_ON_FEEDRATE_CHANGE
  ...
  #define PROBE_OFFSET_WIZARD //AdsFeatures      // Add a Probe Z Offset calibration option to the LCD menu
    ...
    #define PROBE_OFFSET_WIZARD_XY_POS { X_CENTER, Y_CENTER } //AdsFeatures
  #endif
#endif
  ...
  // #define MANUAL_MOVE_DISTANCE_MM                    10, 1.0, 0.1  // (mm) //AdsFeatures
  #define MANUAL_MOVE_DISTANCE_MM         100, 50, 10, 1.0, 0.1  // (mm) //AdsFeatures
  ...
  #define PREHEAT_SHORTCUT_MENU_ITEM //AdsFeatures
  ...
  #define LCD_TIMEOUT_TO_STATUS 15000   // (ms) //AdsFeatures

  // Scroll a longer status message into view
  #define STATUS_MESSAGE_SCROLLING //AdsFeatures
 ...
 */
#define BABYSTEPPING //AdsBBStep
#if ENABLED(BABYSTEPPING)
  //#define EP_BABYSTEPPING                 // M293/M294 babystepping with EMERGENCY_PARSER support
  //#define BABYSTEP_WITHOUT_HOMING
  #define BABYSTEP_ALWAYS_AVAILABLE //AdsBBStep// Allow babystepping at all times (not just during movement)
  ...
  #define DOUBLECLICK_FOR_Z_BABYSTEPPING  //AdsBBStep Double-click on the Status Screen for Z Babystepping.
  ...
  #define BABYSTEP_ZPROBE_OFFSET       //AdsBBStep Combine M851 Z and Babystepping
 ...
 */
#define LIN_ADVANCE //AdsLinearADV
#if ENABLED(LIN_ADVANCE)
  #if ENABLED(DISTINCT_E_FACTORS)
    #define ADVANCE_K { 0.22 }    // (mm) Compression length per 1mm/s extruder speed, per extruder
  #else
    #define ADVANCE_K 0.22        //AdsLinearADV (mm) Compression length applying to all extruders
  #endif
...
#define PTC_BED      // Compensate based on bed temperature //AdsBedLVL
//#define PTC_HOTEND   // Compensate based on hotend temperature
  ...
  //#define PTC_LINEAR_EXTRAPOLATION 4
    ...
    #define PTC_BED_START     65    // (°C) //AdsBedLVL
...
#define BEZIER_CURVE_SUPPORT        // Requires ~2666 bytes //AdsFeatures
 ...
 */
  ...
  #define INTERPOLATE      true
    ...
    #define X_CURRENT       850        //AdsTMC (mA) RMS current. Multiply by 1.414 for peak current.
    #define X_CURRENT_HOME  X_CURRENT-50  //AdsTMC (mA) RMS current for sensorless homing
    ...
    #define Y_CURRENT       850 //AdsTMC
    #define Y_CURRENT_HOME  Y_CURRENT-50 //AdsTMC
   ...
   */
  #define CHOPPER_TIMING CHOPPER_DEFAULT_24V        //AdsTMC All axes (override below)
   ...
   */
  #define MONITOR_DRIVER_STATUS //AdsTMC
   ...
   */
  #define HYBRID_THRESHOLD //AdsTMC

  #define X_HYBRID_THRESHOLD     170  // [mm/s] //AdsTMC
  #define X2_HYBRID_THRESHOLD    100 
  #define Y_HYBRID_THRESHOLD     170//AdsTMC
  #define Y2_HYBRID_THRESHOLD    100
  #define Z_HYBRID_THRESHOLD      25//AdsTMC
  #define Z2_HYBRID_THRESHOLD     25//AdsTMC
   ...
   */
  #define SENSORLESS_HOMING // StallGuard capable drivers only //AdsTMC

  #if ANY(SENSORLESS_HOMING, SENSORLESS_PROBING)
    // TMC2209: 0...255. TMC2130: -64...63
    #define X_STALL_SENSITIVITY 80 //AdsTMC(8)
    #define X2_STALL_SENSITIVITY X_STALL_SENSITIVITY
    #define Y_STALL_SENSITIVITY 80 //AdsTMC(8)
    ...
    // #define IMPROVE_HOMING_RELIABILITY //AdsTMC
  #endif
